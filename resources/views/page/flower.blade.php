...
<body>
  @foreach ($flowers as $key=>$flower)
    ...
    <div class="sh{{$key+1}}" data-modal-target="#modal">
        <img src={{asset('images'.$flower->image)}}   onclick="openModal(modal{{$key+1}})" alt="" id="im{{$key+1}}">
        ...
        <div class="modal" id="modal{{$key+1}}">
            ...
            <div class="modal-body">
              <div class="shop-item">
                ...
                {{-- <img src={{ asset('images'.$flower->image) }}  alt="" class="modal_item"> --}}
                    <span class="shop-item-title" >{{$flower->descr}}</span>
                    <span class="shop-item-price" id="pr{{$flower->id}}">{{$flower->price . "sp"}}</span>
                      <img src="images/flower/pp3-removebg-preview.png" onclick="add.play()"  class="shop-item-button"/>
                  </div>
              </div>
            </div>
            </div>
...
<div data-modal-target="#mod">
    <img src="images/flower/pp3-removebg-preview.png" id="carti" onclick="openModal(mod)"/>
</div>
